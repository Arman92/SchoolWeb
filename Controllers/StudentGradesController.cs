...
namespace SchoolWeb.Controllers
{
    ...
    public class StudentGradesController : Controller
    {
        ...
        public async Task<IActionResult> GetByCourse(int courseId)
        {
            ...
            return Ok(Json(APIResult.New().WithSuccess().WithResult(studentGrades)));
        }
        ...
        public async Task<IActionResult> Post(int courseId, int studentId, [FromBody] float grade)
        {
            using (var tr = nhSession.BeginTransaction())
            {
                ...
                if (course != null && student != null)
                {
                    ...
                    return Ok(Json(APIResult.New().WithSuccess().WithResult(studentGrade)));
                }
                else
                {
        ...
        public async Task<IActionResult> Put([FromBody] StudentGrade studentGradeUpdate)
        {
            ...
            else
            {
                using (var tr = nhSession.BeginTransaction())
                {
                    ...
                    return Ok(Json(APIResult.New().WithSuccess().WithResult(studentGradeToEdit)));
                }
            }
        }
